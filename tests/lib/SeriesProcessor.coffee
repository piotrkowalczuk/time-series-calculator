...
describe 'SeriesProcessor', ()->
  describe '#processData()', ()->
    ...
    beforeEach (done)->
      ...
      processedData = seriesProcessor.processData('7', 12.5)

      done()


    it 'should return proper timestamp', (done)->
      processedData.timestamp.should.equal('7')

      done()


    it 'should calculate properly sum', (done)->
      processedData.sum.should.equal(23.5.toFixed(5))

      done()


    it 'should calculate properly min value', (done)->
      processedData.min.should.equal(11.0.toFixed(5))

      done()


    it 'should calculate properly max value', (done)->
      processedData.max.should.eql(12.5.toFixed(5))
